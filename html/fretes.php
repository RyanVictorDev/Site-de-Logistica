...
<body>
    ...
    <div class="sessoes-servicos">
        <div class="lado-esquerdo text-1">
            <div class="ali-text">
                <h1>Frete comum</h1><p class="text-sessoes">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                    Fugiat totam, sint non a sed dicta nesciunt odit, repellat,
                    maxime debitis praesentium dignissimos error dolorem eum mollitia
                    itaque adipisci quo animi.</p>
            </div>
        </div>
    ...
    <div class="sessoes-servicos">
        ...
        <div class="lado-direito text-2">
            <div class="ali-text">
                <h1>Frete Express</h1><p class="text-sessoes">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Fugiat totam, sint non a sed dicta nesciunt odit, repellat,
                maxime debitis praesentium dignissimos error dolorem eum mollitia
                itaque adipisci quo animi.</p>
            </div>
